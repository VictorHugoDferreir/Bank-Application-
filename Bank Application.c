...
int main()
{
    int codigo[10], i, j, conta;
    double saldo[10], valor, ativo = 0;     //variaveis 
    int verifica = 0;
    int menu;
    
    for(i = 0; i < 10; i++)
    {
        printf("\n\tDigite o codigo da conta %d (3 digitos)\n", i + 1);
        scanf("\n%d", &codigo[i]);
    ...
    while(verifica != 1)    //parametro para rodar o programa e sair do mesmo
    {
